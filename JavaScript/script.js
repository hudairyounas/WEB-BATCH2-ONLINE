...
// var myFirstName = BigInt(422444454534153486454545454785475454545);
...
// const str = "Hello my name is hudair";
...
// console.log(Math.trunc(-4.9));  // -4
// console.log(parseInt(4.9))   // 4 (but not recommended for math)
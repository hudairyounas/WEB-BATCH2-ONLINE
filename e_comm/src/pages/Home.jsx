...
const Home = () => {
  ...
  return (
    <div className="space-y-20 pb-12">
      {/* Hero Section */}
      <section className="relative overflow-hidden rounded-[2.5rem] bg-gradient-to-br from-base-200 via-base-100 to-primary/10 border border-base-200 shadow-xs">
        <div className="container mx-auto px-6 py-16 lg:py-24 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6 text-center lg:text-left">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold tracking-tight text-base-content leading-[1.15]">
              Elevate Your Everyday <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-indigo-600">Style & Living</span>
            </h1>
            
            <p className="text-lg text-gray-500 max-w-xl mx-auto lg:mx-0 font-normal leading-relaxed">
              Discover curated electronics, premium minimalist accessories, and handcrafted homeware designed for the modern connoisseur.
            </p>
            
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start pt-2">
              <Link to="/shop" className="btn btn-primary rounded-full px-8 h-12 text-base shadow-md hover:shadow-lg transition-all gap-2">
                Explore Shop <FaArrowRight className="w-4 h-4" />
              </Link>
              <a href="#categories" className="btn btn-outline rounded-full px-8 h-12 text-base">
                View Categories
              </a>
            </div>
            ...
            <div className="pt-6 border-t border-base-200/80 flex items-center justify-center lg:justify-start gap-4">
              <div className="flex -space-x-2">
                <img className="inline-block h-9 w-9 rounded-full ring-2 ring-base-100 object-cover" src="https://images.unsplash.com/photo-1534528741775-53994a69daeb?w=100&q=80" alt="User" />
                <img className="inline-block h-9 w-9 rounded-full ring-2 ring-base-100 object-cover" src="https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=100&q=80" alt="User" />
                <img className="inline-block h-9 w-9 rounded-full ring-2 ring-base-100 object-cover" src="https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=100&q=80" alt="User" />
              </div>
              <div className="text-left text-xs">
                <div className="flex items-center text-amber-400">
                  <FaStar /><FaStar /><FaStar /><FaStar /><FaStar />
                  <span className="font-bold text-base-content ml-1">4.9/5</span>
                </div>
                <span className="text-gray-400">Trusted by 2,500+ happy shoppers</span>
              </div>
            </div>
          </div>
            ...
            <div className="relative mx-auto max-w-md lg:max-w-none">
              ...
              <div className="absolute -bottom-6 -left-6 bg-base-100/90 backdrop-blur-md border border-base-200 p-4 rounded-2xl shadow-xl flex items-center gap-3 hidden sm:flex">
                ...
                <div>
                  ...
                  <div className="text-[10px] text-gray-400">Free on orders over $50</div>
                </div>
              </div>
              ...
              <div className="absolute -top-6 -right-6 bg-base-100/90 backdrop-blur-md border border-base-200 p-4 rounded-2xl shadow-xl flex items-center gap-3 hidden sm:flex">
                ...
                <div>
                  <div className="font-bold text-xs text-emerald-600">Special Promo</div>
                  <div className="text-[10px] text-gray-400">Save up to 20% today</div>
                </div>
              </div>
            </div>
          </div>
      ...
      <section id="categories" className="space-y-8 scroll-mt-24">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
          <div>
            <span className="text-xs font-semibold text-primary uppercase tracking-wider">Browse Collections</span>
            <h2 className="text-3xl font-bold mt-1">Shop By Category</h2>
          </div>
          <p className="text-gray-500 text-sm max-w-md">Find exactly what you're looking for across our carefully cataloged collections.</p>
        </div>
          ...
          {CATEGORIES.map((cat) => (
            ...
            >
              ...
              <div className="absolute bottom-0 inset-x-0 p-5 text-white flex flex-col justify-end">
                <span className="text-[11px] font-medium text-white/70 uppercase tracking-wide">{cat.itemCount}</span>
      ...
      <section className="space-y-8">
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
          <div>
            <span className="text-xs font-semibold text-primary uppercase tracking-wider">Handpicked Selection</span>
            <h2 className="text-3xl font-bold mt-1">Featured Products</h2>
          </div>
          
          {/* Category Filter Pills */}
          <div className="flex flex-wrap gap-2">
            {['All', 'Electronics', 'Accessories', 'Furniture', 'Home'].map((category) => (
              <button
                key={category}
        ...
        {loading ? (
          ...
          <div className="text-center py-16 bg-base-200/40 rounded-3xl border border-dashed border-base-300">
            ...
            <button onClick={() => setActiveCategory('All')} className="btn btn-sm btn-ghost mt-2">Reset Filter</button>
          </div>
        ) : (
      ...
      <section className="relative overflow-hidden rounded-3xl bg-slate-900 text-white p-8 md:p-12 shadow-xl">
        ...
        <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
          <div className="space-y-4 max-w-xl text-center md:text-left">
            ...
            <h2 className="text-3xl md:text-4xl font-extrabold tracking-tight">Get 20% Off Your Entire First Purchase</h2>
            <p className="text-slate-300 text-sm leading-relaxed">
              Use our exclusive promotional code at checkout to unlock instant savings across all product categories.
            </p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 bg-slate-800/80 p-4 rounded-2xl border border-slate-700 backdrop-blur-md">
            <div className="text-center sm:text-left">
              <span className="text-[10px] text-slate-400 block uppercase tracking-wider">Promo Code</span>
              <span className="font-mono text-xl font-bold tracking-widest text-primary">LUMINA20</span>
            </div>
            <button 
      ...
      <section className="py-6">
        <div className="text-center max-w-xl mx-auto mb-12">
          <span className="text-xs font-semibold text-primary uppercase tracking-wider">Our Commitment</span>
          <h2 className="text-3xl font-bold mt-1">Why Shop With LuminaStore?</h2>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="p-6 rounded-3xl bg-base-100 border border-base-200 shadow-xs hover:shadow-md transition-shadow space-y-4 text-center md:text-left">
            ...
            <p className="text-gray-500 text-sm leading-relaxed">Enjoy complimentary standard shipping on all qualifying orders over $50.</p>
          </div>
          ...
          <div className="p-6 rounded-3xl bg-base-100 border border-base-200 shadow-xs hover:shadow-md transition-shadow space-y-4 text-center md:text-left">
            ...
            <p className="text-gray-500 text-sm leading-relaxed">Your financial transactions are encrypted with enterprise-grade security protocols.</p>
          </div>
          ...
          <div className="p-6 rounded-3xl bg-base-100 border border-base-200 shadow-xs hover:shadow-md transition-shadow space-y-4 text-center md:text-left">
            ...
            <p className="text-gray-500 text-sm leading-relaxed">Not completely satisfied? Return any unused item within 30 days hassle-free.</p>
          </div>
          ...
          <div className="p-6 rounded-3xl bg-base-100 border border-base-200 shadow-xs hover:shadow-md transition-shadow space-y-4 text-center md:text-left">
            ...
            <p className="text-gray-500 text-sm leading-relaxed">Our dedicated customer care representatives are available around the clock.</p>
          </div>
        </div>
      </section>
      ...
      <section className="rounded-3xl bg-base-200/80 border border-base-300 p-8 md:p-14 text-center max-w-4xl mx-auto space-y-6">
        ...
        <div className="space-y-2">
          ...
          <p className="text-gray-500 text-sm max-w-lg mx-auto">
            Subscribe to our newsletter for early access to product drops, secret sales, and 10% off your next order.
          </p>
        </div>
        ...
        <form onSubmit={handleSubscribe} className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto">
          <input 
            ...
            required
          />
          <button type="submit" className="btn btn-primary rounded-full px-8 h-12 text-sm font-semibold">
            Subscribe
          </button>
        </form>

        <div className="flex items-center justify-center gap-6 text-xs text-gray-400 pt-2">
          <span className="flex items-center gap-1"><FaCheckCircle className="text-emerald-500" /> No spam ever</span>
          <span className="flex items-center gap-1"><FaCheckCircle className="text-emerald-500" /> Unsubscribe anytime</span>
        </div>
      </section>
    </div>
  );
